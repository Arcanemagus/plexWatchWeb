				...
				<div class="navbar-inner">
					...
					<ul class="nav">
						...
						<li <?php echo ($page == 'stats') ? "class='active'" : ""; ?>>
							<a href="stats.php">
								<i class="fa fa-area-chart fa-2x" data-toggle="tooltip" data-placement="bottom" title="Stats" id="stats"></i>
							</a>
						</li>
						<li <?php echo ($page == 'charts') ? "class='active'" : ""; ?>>
							<a href="charts.php">
								<i class="fa fa-bar-chart fa-2x" data-toggle="tooltip" data-placement="bottom" title="Charts" id="charts"></i>
							</a>
						</li>
						<li <?php echo ($page == 'settings') ? "class='active'" : ""; ?>>
							<a href="settings.php">
								<i class="fa fa-cogs fa-2x" data-toggle="tooltip" data-placement="bottom" title="Settings" id="settings"></i>
							</a>
						</li>
					</ul>
				</div>
